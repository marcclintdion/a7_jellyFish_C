...
//================================================================================== 
   ...
   //MultiplyMatrix(modelView, modelView, modelWorld);  
   MultiplyMatrix(mvpMatrix, projection, modelView);                                                                                                                         
    ...
    glUniform1f(UNIFORM_MIN_ADJUST_jadeMonkey, jadeMonkey_minAdjust);  
    glUniform1f(UNIFORM_POW_ADJUST_jadeMonkey, jadeMonkey_powAdjust);  
    glUniform1f(UNIFORM_DIVISOR_ADJUST_jadeMonkey, jadeMonkey_divisorAdjust);  
