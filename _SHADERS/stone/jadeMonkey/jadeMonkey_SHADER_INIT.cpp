   ...
   //--------------------------------------------      
      ...
      "    {                                                                                                                                     \n"
                   ...
                   //---------------------------------------------------------------------------------------------------------
      "            viewDirection          = highp vec3(0.0, 0.0, 1.0) - (lightMatrix * position).xyz;                                                                                \n"
      ...
      "    uniform highp float   minAdjust;                                                                                              \n" 
      "    uniform highp float   powAdjust ;                                                                                              \n" 
      "    uniform highp float   divisorAdjust;                                                                                              \n" 
      ...
      "        highp float opacity       =  min(minAdjust, (powAdjust+texture2D(Texture1, varTexcoord.st).b) / abs(pow(dot(normal, normalize(viewDirection) ), divisorAdjust) ) );                                     \n" 


      
       "        gl_FragColor.a            = opacity + (gloss_01.x + gloss_02.x + gloss_04.x) * .15;                                     \n" 
      ...
      UNIFORM_MIN_ADJUST_jadeMonkey                      = glGetUniformLocation(jadeMonkey_SHADER,      "minAdjust");
      UNIFORM_POW_ADJUST_jadeMonkey                      = glGetUniformLocation(jadeMonkey_SHADER,      "powAdjust");
      UNIFORM_DIVISOR_ADJUST_jadeMonkey                  = glGetUniformLocation(jadeMonkey_SHADER,      "divisorAdjust"); 
